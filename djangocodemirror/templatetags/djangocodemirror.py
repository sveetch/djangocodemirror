...
@register.filter
def codemirror_config(field):
    """
    Filter to include CodeMirror parameters as a JSON string.
    ...
    Example:
        ...
        {% load djangocodemirror %}
        {{ form.myfield|codemirror_config }}
...
codemirror_config.is_safe = True
